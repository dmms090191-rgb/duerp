      ...
      <main className="flex-grow bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
          ...
          <section className="mb-8 sm:mb-12">
            <div className="bg-white rounded-xl p-6 sm:p-8 md:p-10 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-start">
                ...
                <div className="flex justify-center">
                  <img
                    ...
                    className="rounded-lg shadow-md w-full max-h-64 md:max-h-full object-cover"
                  />
                </div>
              </div>
            </div>
          ...
          <section className="mb-8 sm:mb-12">
            <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white rounded-xl p-6 sm:p-8 md:p-12 shadow-xl hover:shadow-2xl transition-shadow">
              ...
              <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-blue-50 leading-relaxed">
                <p>
                ...
                <div className="bg-blue-800/50 rounded-lg p-3 sm:p-4 mt-4 sm:mt-6 border-l-4 border-yellow-400">
                  <div className="flex items-start gap-2 sm:gap-3">
                    <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-400 flex-shrink-0 mt-0.5 sm:mt-1" />
          ...
          <section className="mb-8 sm:mb-12">
            <div className="bg-white rounded-xl p-6 sm:p-8 md:p-10 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-start">
                ...
                <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-700 leading-relaxed order-1 md:order-2">
                  <p>
