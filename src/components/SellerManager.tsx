  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('Seller créé avec succès:', data);
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-gray-900">
                {sellers.filter(seller =>
                  seller.dateCreation.includes(new Date().toLocaleDateString('fr-FR'))
                ).length}
              </span>
            </div>
          </div>
        ...
        <div className="max-w-4xl">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Gestionnaire de Sellers</h1>
            </div>
          ...
          {activeTab === 'add' && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">Ajouter un seller</h2>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">
                      Liste des Sellers ({sellers.length})
                    </h2>
                  </div>
              ...
              {sellers.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Aucun seller créé</h3>
                  <p className="text-gray-500 mb-6">Commencez par ajouter votre premier seller</p>
                  <button
                    onClick={() => setActiveTab('add')}
            ...
            <div className="bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 px-8 py-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-white mb-1">Détails du Seller</h2>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">ID: #{selectedSellerDetails.id}</p>
                  </div>
                </div>
              </div>
