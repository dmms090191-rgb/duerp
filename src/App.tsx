  ...
  const handleAdminLoginAsClient = (lead: Lead) => {
    const clientData = {
      ...
      client: {
        ...
        diagnostic_final_actif: lead.diagnostic_final_actif || false,
        type_diagnostic: lead.type_diagnostic || null
      }
    };
  ...
  const handleSellerLoginAsClient = (client: any) => {
    const clientData = {
      ...
      client: {
        ...
        diagnostic_final_actif: client.diagnostic_final_actif || false,
        type_diagnostic: client.type_diagnostic || null
      }
    };
    setClientData(clientData);
    sessionStorage.setItem('clientData', JSON.stringify(clientData));
