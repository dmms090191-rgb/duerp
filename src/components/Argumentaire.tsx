    ...
    <div className="bg-white rounded-xl shadow-sm p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Argumentaire</h2>
            <p className="text-sm text-gray-500">Gérez vos arguments de vente</p>
          </div>
        </div>
        <button
      ...
      {addingNew && (
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <h3 className="font-semibold text-gray-900 mb-3">Nouvel argument</h3>
        ...
        {Object.entries(groupedItems).map(([categorie, categoryItems]) => (
          <div key={categorie}>
            <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
              ...
              {categorie}
              <span className="text-sm text-gray-500 font-normal">({categoryItems.length})</span>
            </h3>
                    ...
                    <>
                      ...
                      {expandedItems.has(item.id) && (
                        <div className="px-4 pb-4 pt-0 border-t border-gray-200 bg-gray-50">
                          <p className="text-gray-700 whitespace-pre-wrap">{item.contenu}</p>
                        </div>
                      )}
                    </>
                  )}
      ...
      {filteredItems.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">Aucun argument trouvé</p>
        </div>
      )}
    </div>
  );
